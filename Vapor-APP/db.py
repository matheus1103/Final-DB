...
usuario = "INSIRA AQUI O NOME DO SEU USUARIO NO POSTGRESQL (padrão: postgres)"
senha = "INSIRA AQUI A SUA SENHA DO POSTGRESQL"
ip = "INSIRA AQUI O IP DO SEU POSTGRESQL"
porta = "INSIRA AQUI A PORTA DO SEU POSTGRESQL (padrão: 5432)"
db_name =  "INSIRA AQUI O NOME DO SEU BANCO DE DADOS"
